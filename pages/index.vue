        ...
        <v-card color="#00afb9">
          <div class="d-flex flex-no-wrap justify-space-between">
            <div>
              ...
              <v-card-subtitle>
                nächstgelegene Tram-Station heißt Hasemannstraße
                <v-btn
              ...
              <v-card-text>
                Feld 5 (Warm-Up-Feld) nur mit Tausendfüßlern oder Laufschuhen
                benutzen (ist ein Hockeyrasen)
              </v-card-text>
            </div>
            <v-avatar class="ma-3" size="80" tile>
          ...
          <v-card-actions>
            ...
            <v-btn
              href="https://drive.google.com/file/d/1oYIdP5ib4SrkGOmKpr4oF2qoKFo2B7Hy/view"
              target="_blank"
            >
              Lageplan<v-icon right dark> mdi-open-in-new</v-icon>
            </v-btn>
          </v-card-actions>
        </v-card>
      </v-col>
